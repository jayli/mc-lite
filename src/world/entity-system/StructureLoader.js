...
export const structureLoaders = {
  ...
  treeTower: new StructureLoader('tree_tower', new URL('../structures/tree_tower.json', moduleBase).href),
  junglePyramid: new StructureLoader('jungle_pyramid', new URL('../structures/jungle_pyramid.json', moduleBase).href),
...
export async function preloadAllStructures() {
  await Promise.all([
    ...
    structureLoaders.treeTower.load(),
    structureLoaders.junglePyramid.load(),
